...
public class OutputTopicTest {
	...
	public void testTopologyLogic() {
		...
		assertThat(keyValues.get(0).key).isEqualTo(11);
		assertThat(keyValues.get(1).key).isEqualTo(11);
		assertThat(keyValues.get(2).key).isEqualTo(12);
		assertThat(keyValues.get(0).value).isEqualTo("test1_suffix");
		assertThat(keyValues.get(1).value).isEqualTo("test2_suffix");
		assertThat(keyValues.get(2).value).isEqualTo("test3_suffix");
	}
}
