...
public class OutputTopicTest {
	...
	public void testTopologyLogic() {
		...
		Awaitility.waitAtMost(Duration.ofSeconds(5)).until(() -> outputTopic.getQueueSize() == 5L);
		assertThat(outputTopic.readValuesToList()).isEqualTo(List.of("test1", "test1test2", "test3", "test3test4", "test5"));
	}
}
