...
public class SeparateWebSocketAndOutputTopicConfigTest {
    private final Logger logger = LoggerFactory.getLogger(SeparateWebSocketAndOutputTopicConfigTest.class);
