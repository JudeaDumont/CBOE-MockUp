...
public class OutputTopicTest {
	...
	public void testTopologyLogic() {
		...
		Awaitility.waitAtMost(Duration.ofSeconds(5)).until(() -> outputTopic.getQueueSize() == 9L);
		assertThat(outputTopic.readValuesToList()).isEqualTo(List.of("anull", "bnull", "cnull", "gnull", "hnull", "ad", "be", "cf", "nulli"));
