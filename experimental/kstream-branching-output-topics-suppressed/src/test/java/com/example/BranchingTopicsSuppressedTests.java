...
public class BranchingTopicsSuppressedTests {
	...
	public void testTopologyLogic() {
		...
		assertThat(outputTopicA.readValuesToList()).isEqualTo(List.of(2L));
		assertThat(outputTopicB.readValuesToList()).isEqualTo(List.of(2L));
		assertThat(outputTopicC.readValuesToList()).isEqualTo(List.of(2L));
	}
