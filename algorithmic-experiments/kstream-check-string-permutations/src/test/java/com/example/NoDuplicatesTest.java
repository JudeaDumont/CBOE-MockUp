...
public class NoDuplicatesTest {
	private final Logger logger = LoggerFactory.getLogger(NoDuplicatesTest.class);
	...
	public void testTopologyLogic() {
		inputTopic.pipeInput("wordgoodgoodgoodbestword", List.of("word","good","best","good"), 1L);
