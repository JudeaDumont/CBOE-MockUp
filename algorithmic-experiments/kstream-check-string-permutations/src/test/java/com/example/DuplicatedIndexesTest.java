...
@SpringBootTest
public class DuplicatedIndexesTest {
	private final Logger logger = LoggerFactory.getLogger(DuplicatedIndexesTest.class);
	...
	public void testTopologyLogic() {
		inputTopic.pipeInput("foobarfoobar", List.of("foo","bar"), 1L);
